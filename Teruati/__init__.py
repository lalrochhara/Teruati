...
log.info("[Teruati] Teruati is starting. | An Teruati Supports Project. | Licensed under GPLv3.")
log.info("[Teruati] Not affiliated to Azur Lane or Yostar in any way whatsoever.")
log.info("[Teruati] Project maintained by: github.com/Dank-del (t.me/Nickylrca)")

# if version < 3.6, stop bot.
if sys.version_info[0] < 3 or sys.version_info[1] < 7:
    log.error(
        "[Teruati] You MUST have a python version of at least 3.7! Multiple features depend on this. Bot quitting."
    )
    quit(1)
...
class TeruatiINIT:
    def __init__(self, parser: ConfigParser):
        ...
        self.bot_name = "Teruati" #placeholder
        self.bot_username = "TeruatiRobot" #placeholder
...
KInit = TeruatiINIT(parser=kigconfig)
...
from Teruati.modules.sql import SESSION
...
from Teruati.modules.helper_funcs.handlers import CustomCommandHandler
