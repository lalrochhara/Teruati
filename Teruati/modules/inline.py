...
import Teruati.modules.sql.users_sql as sql
from Teruati import (
    OWNER_ID,
    SUDO_USERS,
    SUPPORT_USERS,
...
from Teruati.modules.helper_funcs.misc import article
from Teruati.modules.helper_funcs.decorators import kiginline
...
def inlinequery(update: Update, _) -> None:
    ...
    inline_help_dicts = [
        ...
        {
            "title": "Account info on Teruati",
            "description": "Look up a Telegram account in Teruati database",
            "message_text": "Click the button below to look up a person in Teruati database using their Telegram ID",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Teruati",
            "message_text": "Click the button below to get to know about Teruati.",
            "thumb_urL": "https://telegra.ph/file/c85e07b58f5b3158b529a.jpg",
            "keyboard": ".about ",
        },
        {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a part of Teruati Supports"
        nation_level_present = True
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="Report Error",
                    url=f"https://t.me/TeruatiSupports",
                ),
                InlineKeyboardButton(
                    text="Search again",
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    sql.update_user(user.id, user.username)
    about_text = f"""
    Teruati (@{context.bot.username})
    Maintained by [Dank-del](t.me/Nickylrca)
    ...
    kb = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="Channel",
                    url=f"https://t.me/TeruatiUpdates",
                ),
                InlineKeyboardButton(
                    text='Ping',
            ...
            [
                InlineKeyboardButton(
                    text="GitLab",
                    url=f"https://www.gitlab.com/Nickylrca/Teruati",
                ),
                InlineKeyboardButton(
                    text="GitHub",
                    url="https://www.github.com/Nickylrca/Teruati",
                ),
            ],
        ])
    ...
    results.append(
        ...
        InlineQueryResultArticle
            (
            id=str(uuid4()),
            title=f"About Teruati (@{context.bot.username})",
