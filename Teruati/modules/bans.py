...
from Teruati.modules.helper_funcs.extraction import extract_user_and_text
from Teruati.modules.helper_funcs.string_handling import extract_time
from Teruati.modules.log_channel import loggable, gloggable
...
def ban(update, context):  # sourcery no-metrics
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text("Bring an order from Teruati Supports to fight a Sardegna.")
