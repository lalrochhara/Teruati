from Teruati.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
from telegram.ext import CommandHandler, MessageHandler, CallbackQueryHandler, InlineQueryHandler
from telegram.ext.filters import BaseFilter
from Teruati import dispatcher as d, log
from typing import Optional, Union, List



class TeruatiTelegramHandler:
    def __init__(self, d):
        self._dispatcher = d
...
kigcmd = TeruatiTelegramHandler(d).command
kigmsg = TeruatiTelegramHandler(d).message
kigcallback = TeruatiTelegramHandler(d).callbackquery
kiginline = TeruatiTelegramHandler(d).inlinequery
