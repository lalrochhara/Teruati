...
import telegram
from Teruati import SARDEGNA_USERS, WHITELIST_USERS, dispatcher
from Teruati.modules.disable import DisableAbleCommandHandler
from Teruati.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from Teruati.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from Teruati.modules.helper_funcs.string_handling import split_quotes
from Teruati.modules.log_channel import loggable
from Teruati.modules.sql import warns_sql as sql
