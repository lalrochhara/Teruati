...
import Teruati.modules.sql.userinfo_sql as sql
from Teruati import SUDO_USERS, DEV_USERS
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text("Erm... yeah, I only trust Teruati Supports to set my bio.")
            return
