...
from Teruati.modules.helper_funcs.chat_status import whitelist_plus, dev_plus, sudo_plus
from Teruati.modules.helper_funcs.extraction import extract_user
from Teruati.modules.log_channel import gloggable
from Teruati.modules.sql import nation_sql as sql
...
def addsudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in SUPPORT_USERS:
        rt += "Requested Teruati Supports to promote a Support user to Sudo."
        SUPPORT_USERS.remove(user_id)

    if user_id in WHITELIST_USERS:
        rt += "Requested Teruati Supports to promote a Whitelist user to Sudo."
...
def addsupport(
    ...
    if user_id in SUDO_USERS:
        rt += "Requested Teruati Supports to demote this Sudo to Support"
    ...
    if user_id in WHITELIST_USERS:
        rt += "Requested Teruati Supports to promote this Whitelist user to Support"
        WHITELIST_USERS.remove(user_id)
...
def removesudo(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in SUDO_USERS:
        message.reply_text("Requested Teruati Supports to demote this user to Civilian")
        SUDO_USERS.remove(user_id)
...
\n*Teruati Supports* - Devs who can access the bots server and can execute, edit, modify bot code. Can also manage other Nations
...
Report abuse or ask us more on these at [Teruati Supports](https://t.me/TeruatiSupports).
"""
...
def devlist(update: Update, context: CallbackContext):
    ...
    reply = "<b>Teruati Supports Members :</b>\n"
