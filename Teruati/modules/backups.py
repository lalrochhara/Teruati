...
import Teruati.modules.sql.notes_sql as sql
from Teruati import dispatcher, log as LOGGER, OWNER_ID
from Teruati.__main__ import DATA_IMPORT
from Teruati.modules.helper_funcs.chat_status import user_admin
from Teruati.modules.helper_funcs.alternate import typing_action
from Teruati.modules.helper_funcs.decorators import kigcmd
# from Teruati.modules.rules import get_rules
import Teruati.modules.sql.rules_sql as rulessql
from Teruati.modules.language import gs
# from Teruati.modules.sql import warns_sql as warnssql
import Teruati.modules.sql.blacklist_sql as blacklistsql
from Teruati.modules.sql import disable_sql as disabledsql

# from Teruati.modules.sql import cust_filters_sql as filtersql
# import Teruati.modules.sql.welcome_sql as welcsql
import Teruati.modules.sql.locks_sql as locksql
from Teruati.modules.connection import connected
...
def export_data(update, context):  # sourcery no-metrics
    ...
    with open("TeruatiRobot{}.json".format(chat_id), "w") as f:
        f.write(str(baccinfo))
    context.bot.sendChatAction(current_chat_id, "upload_document")
    tgl = time.strftime("%H:%M:%S - %d/%m/%Y", time.localtime(time.time()))
    context.bot.sendDocument(
        current_chat_id,
        document=open("TeruatiRobot{}.json".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `TeruatiRobot-Backup` was specially made for notes.".format(
    ...
    os.remove("TeruatiRobot{}.json".format(chat_id))  # Cleaning file
