...
import Teruati.modules.sql.connection_sql as sql
from Teruati import dispatcher, SUDO_USERS, DEV_USERS
from Teruati.modules.helper_funcs import chat_status
