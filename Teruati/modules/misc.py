...
from Teruati.__main__ import STATS, USER_INFO, TOKEN
from Teruati.modules.sql import SESSION
from Teruati.modules.helper_funcs.chat_status import user_admin, sudo_plus
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/Nickylrca/Teruati) | [⍚ GitLab](https://gitlab.com/Nickylrca/Teruati)\n\n" +
