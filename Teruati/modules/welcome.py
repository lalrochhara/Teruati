...
import Teruati.modules.sql.welcome_sql as sql
from Teruati import (
    DEV_USERS,
    log,
    OWNER_ID,
...
from Teruati.modules.helper_funcs.msg_types import get_welcome_type
from Teruati.modules.helper_funcs.string_handling import (
    escape_invalid_curly_brackets,
    markdown_parser,
)
from Teruati.modules.log_channel import loggable
from Teruati.modules.sql.antispam_sql import is_user_gbanned
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Whoa! A member of the Teruati Supports just joined!",
                    reply_to_message_id=reply,
                )
                continue
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the Teruati Supports!",
                    reply_to_message_id=reply,
                )
                return
