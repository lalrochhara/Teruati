...
from Teruati.modules import ALL_MODULES
from Teruati.modules.helper_funcs.chat_status import is_user_admin
from Teruati.modules.helper_funcs.misc import paginate_modules
from Teruati.modules.helper_funcs.decorators import kigcmd, kigcallback, kigmsg
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Teruati.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        kb.append([InlineKeyboardButton(text='Support', url='https://t.me/TeruatiSupports'),
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                ...
                                url='https://t.me/TeruatiSupports',
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "updates_channel_link_btn"),
                                url="https://t.me/TeruatiUpdates",
                            ),
                            InlineKeyboardButton(
                                text=gs(chat.id, "src_btn"),
                                url="https://github.com/Nickylrca/Teruati",
                            ),
                        ],
                        [
                            InlineKeyboardButton(
    ...
    try:
        if mod_match:
            ...
            help_buttons.append(
                ...
                InlineKeyboardButton(text='Support', url='https://t.me/TeruatiSupports')]
            )
...
def main():
    ...
    if WEBHOOK:
        ...
        log.info(f"Teruati started, Using long polling. | BOT: [@{dispatcher.bot.username}]")
        TeruatiINIT.bot_id = dispatcher.bot.id
        TeruatiINIT.bot_username = dispatcher.bot.username
        TeruatiINIT.bot_name = dispatcher.bot.first_name
...
if __name__ == "__main__":
    log.info("[Teruati] Successfully loaded modules: " + str(ALL_MODULES))
